...
class CPIRatioViewController: ViewController {
    ...
    override func bindViewModel() {
        super.bindViewModel()
        guard let viewModel = self.viewModel as? CPIRatioViewModel else { return }
        
        let input = CPIRatioViewModel.Input()
